// ============================================
// Symptom Analysis Engine — Server-side
// Keyword-based triage for classifying symptoms
// ============================================
...
function analyze(symptomText) {
  ...
  for (const [keyword, specs] of Object.entries(criticalKeywords)) {
  ...
  for (const [keyword, specs] of Object.entries(normalKeywords)) {
    if (text.includes(keyword)) {
